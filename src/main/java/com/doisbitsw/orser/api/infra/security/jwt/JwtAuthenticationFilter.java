package com.doisbitsw.orser.api.infra.security.jwt;

import com.doisbitsw.orser.api.users.User;
import com.doisbitsw.orser.api.users.UserDTO;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            com.doisbitsw.orser.api.infra.security.jwt.JwtLoginInput login = new ObjectMapper().readValue(request.getInputStream(), JwtLoginInput.class);
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        String jwtToken = com.doisbitsw.orser.api.infra.security.jwt.JwtUtil.createToken(user);

//        String json = ServletUtil.getJson("token", jwtToken);
        String json = UserDTO.create(user, jwtToken).toJson();
        com.doisbitsw.orser.api.infra.security.jwt.ServletUtil.write(response, HttpStatus.OK, json);
    }
